...
def generate_with_pipeline(wan_i2v, wav2vec_feature_extractor, audio_encoder, rank, args):
    generated_list = []
    with open(args.input_json, 'r', encoding='utf-8') as f:
        input_data = json.load(f)
        
    # wav2vec_feature_extractor, audio_encoder= custom_init('cpu', args.wav2vec_dir) # Moved to load_pipeline
...
def generate(args):
    wan_i2v, wav2vec_feature_extractor, audio_encoder, rank = load_pipeline(args)
